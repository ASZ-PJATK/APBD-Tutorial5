...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = from e in emps
            ...
            join s in grades on true equals true // this will allow the next where clause to filter salaries
        ...
        Assert.Contains(resultList, r => r.EName == "ALLEN" && r.DName == "SALES" && r.Grade == 3);
    }
}
